...
from _shared import (
    ...
    s3_get_json, s3_put_json, verify_token,
)

DEFAULT_PAGES_SEO = {
    '/': {
        'title': 'Автошкола Время Рулить Севастополь — обучение вождению от 64 000 ₽',
        'description': 'Автошкола в Севастополе. Опытные инструкторы, автодром, инструктор-женщина, рассрочка без банков. Стоимость курса 64 000 ₽ с топливом.',
        ...
        'og_description': 'Учим вождению честно. Цена 64 000 ₽ с топливом. Автодром. Инструктор-женщина.',
