...
DEFAULT_CONTENT = {
    ...
    'pricing': {
        ...
        'old_price': '75 000',
        'discount': '-11 000',
        'includes': '+5 000 ТОПЛИВНЫЙ СБОР',
        'fuel_note': 'В связи с ростом цен на топливо, с 13.07.2026 ко всем программам обучения добавляется временный топливный сбор в размере 5 000 ₽. Мера действует до стабилизации цен. Средства направлены на бесперебойное проведение практических занятий.',
    ...
    'terms_page': {
        ...
        'phone': '+7 978 502 11 13',
        'city': 'г. Севастополь',
        'complaints_deadline_days': '30',
        'intro_text': 'Настоящее Пользовательское соглашение является публичной офертой ООО «ВРЕМЯ РУЛИТЬ» и регулирует отношения между Администрацией Сайта и пользователями.',
        'min_age': '18',
        'allowed_functions': 'Просмотр информации и материалов; использование форм обратной связи, заказа звонка, подписки; иные функции, явно представленные на Сайте.',
        'prohibited_actions': 'Использование в мошеннических или незаконных целях; копирование и распространение контента без разрешения; нарушение работы Сайта; распространение спама, оскорблений, нецензурной лексики.',
        'ip_statement': 'Весь контент Сайта (тексты, дизайн, графика, логотипы) принадлежит Администрации Сайта или правообладателям. Использование без письменного согласия запрещено.',
        'liability_admin': 'Сайт предоставляется «как есть». Администрация не гарантирует бесперебойную работу и не несёт ответственности за убытки, связанные с невозможностью использования Сайта.',
