...
const faqs = [
  { q: 'Сколько длится обучение?',             a: 'Стандартный курс — 2,5 месяца. Это наше главное преимущество. Можно быстрее за счёт интенсивного графика. Мы гибко подстраиваемся: можно учиться 2–3 раза в неделю или интенсивно каждый день.' },
  ...
  { q: 'Где находится автодром?',              a: 'Стахановцев, 18 — это наш арендованный автодром. Инструктор встречает на остановке Хрюкина на Острякова и отвозит на автодром — идти пешком не нужно.' },
  { q: 'Есть ли бесплатные занятия?',         a: 'Первое занятие в классе бесплатно, первая неделя онлайн бесплатно.' },
];
